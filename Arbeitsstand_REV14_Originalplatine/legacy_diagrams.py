...
class Diagram(Flowable):
 ...
 def draw(self):
  ...
  if self.kind=='system':
   ...
   box(407,65,109,94,'Märklin-Träger|MV (grün)|MR (blau)')
   ...
   txt(5,12,'Erst nach Motorprüfung am passenden Märklin-Träger anschließen.',10,red,True)
   ...
   box(12,54,224,44,'Märklin-Träger / Decoder')
