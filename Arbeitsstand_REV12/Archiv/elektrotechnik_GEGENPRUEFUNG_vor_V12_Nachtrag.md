...
| V-12 | Konkreter Restenergie-Handgriff fehlt; angegebene ICE-Elkoquelle nicht bestätigt | Entladeprinzip sinnvoll; feste Zeit/Spannung/1 kΩ ohne Auslegung nicht universell gültig |
...
**Quellenlücke:** Die genaue Behauptung „C1/C2, ab 100 µF, optimal 330 µF 25 V“ wurde auf der aktuell abgerufenen ICE-M-Herstellerseite und im Shop nicht gefunden. 330 µF wird für ein anderes Produkt WiB-A v2 genannt. Das widerlegt frühere/andere Herstellerunterlagen nicht, verlangt aber eine exakte revisionspassende Quelle. [ICE-M-Seite](https://lokstoredigital.jimdoweb.com/hardware/beleuchtung/lodi-wib-ice-m/), [anderes Produkt WiB-A v2](https://lokstoredigital.jimdoweb.com/hardware/beleuchtung/lodi-wib-a/).
