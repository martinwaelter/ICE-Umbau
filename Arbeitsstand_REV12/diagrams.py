...
class Diagram(Flowable):
 ...
 def draw(self):
  ...
  if self.kind=='system':
   box(2,63,149,105,'MOTORKOPF|60941 + 60977|LoDi 511|Weiß / Rot + Sound')
   box(185,63,144,105,'MITTELWAGEN|LoDi ICE-M|O = RT   L = GE|Innenlicht')
   box(363,63,155,105,'MOTORLOSER KOPF|59649 + Märklin-Träger|Rot / Weiß|GE endet isoliert')
   ...
   txt(73,12,'Beide Schleifer: ein gemeinsamer Digitalstromkreis',10,red,True)
   txt(2,182,'ZIEL: ein mfx-Zugeintrag, keine Zentralen-Traktion',11,teal,True)
  elif self.kind=='nets':
   ...
   box(407,65,109,94,'LoDi 511|MOT_L|MOT_R')
   ...
   box(180,5,166,190,'LoDi 511|60977 erst später')
   ...
   box(205,4,137,191,'Märklin-Träger|ESU 59649 hinten')
   ...
   box(2,70,82,97,'');txt(10,143,'59649',10,teal,True);txt(10,114,'+Ub',10,teal)
   box(425,70,92,97,'');txt(425,185,'59649',10,teal,True)
   ...
   box(2,80,150,85,'MOTORSEITE|Motor + Drosseln|Litzen von LoDi getrennt')
   box(376,80,141,85,'AUSSEN|PM1 / PM2|PX / PX2 zum Metall')
   line(152,137,376,137,teal);line(152,106,376,106,grey)
   line(264,91,264,110,red);line(264,145,264,161,red)
   txt(195,174,'Gehäusewand',10,grey)
   txt(186,70,'vorhandene Öffnung',10,red)
   txt(174,42,'nur mit freier Leitungslage',10,red)
   txt(3,10,'Prinzip: tatsächliche Öffnung und Clipraum am eigenen Kopf prüfen.',10,grey)
