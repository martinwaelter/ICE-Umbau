...
class Diagram(Flowable):
 ...
 def draw(self):
  ...
  if self.kind=='system':
   ...
   box(4,78,110,84,'GLEIS|B: Schleifer|0: Räder')
   box(174,56,169,124,'EIN DECODER|Gleichrichter|U+ = Funktionsplus|GND = Elektronikminus|LV / LR = geschaltet')
   box(405,78,110,84,'FRONT-LED|U+ / Plus|Lichtausgang')
   line(114,143,174,143,red);line(114,99,174,99,grey)
   line(343,143,405,143,teal);line(343,99,405,99,ink)
   txt(5,29,'B, 0, U+ und GND getrennt benennen. Kabelfarbe allein genügt nicht.',10,ink,True)
   txt(5,9,'Kein U+ / GND an Chassis; kein U+ zwischen beiden Decodern verbinden.',10,red)
   ...
   box(2,70,82,97,'+Ub|derselbe|59649')
   box(425,70,92,97,'Ausgänge|59649')
