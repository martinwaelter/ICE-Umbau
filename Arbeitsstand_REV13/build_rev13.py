...
# Diese Korrekturen verwenden bereits die finalen Seitenzahlen der REV13.
final_pages={item['n']:item for item in pages}
for name in ['usability_ablauf','usability_programmierung','usability_elektrik','usability_root']:
 __import__(name).apply(final_pages)
for p in pages:
